...
| Full timer | Settings |
|---|---|
| ![SitStandGo full timer](docs/screenshots/full-mode.png) | ![SitStandGo settings](docs/screenshots/settings.png) |

| Mini mode | Floating reminder |
|---|---|
| ![SitStandGo mini mode](docs/screenshots/mini-mode.png) | ![SitStandGo floating popup](docs/screenshots/floating-popup.png) |
